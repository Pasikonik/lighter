...
(function() {
  $(function() {
    var $container, type;
    $('.btn-to-upload').click(function() {
      return $('#image_src').trigger('click');
    });
    ...
    $('#new_image').bind('fileuploadstart', function(e, data) {
      return $(".progress").css('display', 'inline');
    });
    $('#new_image').bind('fileuploadstop', function(e, data) {
    ...
    if (type) {
      ...
      return $("#graphics").addClass('active');
    }
  });
...
(function() {
  $(function() {
    ...
    $('#search-field').focusout(function() {
      ...
      return $('#search-field').css('width', '0px');
    });
    $('#login').on('shown.bs.modal', function() {
      return $('#login_field').focus();
    });
    $('#registration').on('shown.bs.modal', function() {
      return $('#reg_field').focus();
    });
    flashCallback = function() {
      return $(".alert-info, .alert-success").fadeOut();
    };
...
(function() {
  ...
  checkStars = function(amount) {
    var i, j, k, ref, ref1, results;
    if (amount < 5) {
      for (i = j = ref = amount + 1; ref <= 5 ? j <= 5 : j >= 5; i = ref <= 5 ? ++j : --j) {
        $("span[data-score='" + i + "']").text("☆");
      }
    }
    results = [];
    for (i = k = 1, ref1 = amount; 1 <= ref1 ? k <= ref1 : k >= ref1; i = 1 <= ref1 ? ++k : --k) {
      results.push($("span[data-score='" + i + "']").text("★"));
    }
    return results;
  };

  $(function() {
    var idVideo, sort, stars, tag, type;
    ...
    if (idVideo) {
      $.get("/videos/" + idVideo + "/tags", function(data) {
        return $(".tm-input").tagsManager({
          prefilled: data,
    ...
    $("span[data-score]").on('click', function() {
      var index, path;
    ...
    $("a[href='#local']").click(function() {
      return $("input[name='video[remote]'").val('');
    });
    return $("a[href='#remote']").click(function() {
      return $("input[name='video[source]'").val('');
    });
  });
